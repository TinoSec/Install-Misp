...
Crear el archivo Install.sh, podes encontrar el contenido del archivo mas abajo

```bash
nano Install.sh
```
Volver ejecutable este archivo

```bash
chmod +x Install.sh
```
Ejecutar el script con "-A", para instalar todos los modulos de Misp
...
![Feed-Misp](https://github.com/TinoSec/Install-Misp/blob/main/EnableFeed2.png)
